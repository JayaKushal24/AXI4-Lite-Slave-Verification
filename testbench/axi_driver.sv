...
/* 		forever begin
	...
	task drive(axi_seq_item req,axi_seq_item rsp);
		...
		`uvm_info("DRIVER",$sformatf("TIME=%0t ARESETN=%b| AWADDR=%08h AWPROT=%0h AWVALID=%0b | WDATA=%08h WSTRB=%0h WVALID=%0b | BREADY=%0b | ARADDR=%08h ARPROT=%0h ARVALID=%0b | RREADY=%0b",
            					$time,rsp.ARESETn,req.AWADDR, req.AWPROT, req.AWVALID,req.WDATA, req.WSTRB, req.WVALID,req.BREADY,req.ARADDR, req.ARPROT, req.ARVALID,req.RREADY),UVM_LOW)
